    ...
    public partial class entity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParticipantParents", x => new { x.ParticipantId, x.ParentId });
                    table.ForeignKey(
                        name: "FK_ParticipantParents_Parent_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Parent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParticipantParents_Participant_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParticipantParents_ParentId",
                table: "ParticipantParents",
                column: "ParentId");
        }
